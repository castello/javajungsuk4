...
//			if(obj.equals(data[i])) { // obj가 null이면 NullPointerException발생
            if(Objects.equals(obj, data[i])) { // obj가 null이어도 OK
                remove(i);
                return true;
            }
        }
...
//	public void sort(Comparator c) { /* 내용생략 */ }              
//	public Spliterator spliterator() { /* 내용생략 */ }            
//	public void replaceAll(UnaryOperator operator){/* 내용생략 */} 
}